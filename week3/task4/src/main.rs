        ...
        let target = match country_to_conquer {
          ...
          _ => {
            ...
            continue;
				...
				let my_country = test_player.get_country().get_name().to_string();
				test_player.conquer_nation(target, &my_country);
			},
      0 => break,
